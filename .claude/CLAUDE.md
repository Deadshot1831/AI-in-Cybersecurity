...
## IMPORTANT: Codebase Intelligence Instructions for AI_in_Cyber_Security
...
Last indexed: 2026-04-12 (commit a1ad0d7). Confidence: 100%.
### Architecture
repo is a high-performance, TypeScript-centric monorepo designed for complex data visualization and analysis. The project leverages a robust ecosystem of specialized libraries—including d3 for data manipulation, cytoscape for graph-based visualizations, and mermaid for diagramming—to provide a sophisticated frontend experience. With a codebase dominated by TypeScript (71.4%), the project emphasizes type safety and modular architecture to manage its 11,704 lines of code effectively across 112 files. The project is built on a modern web stack with a focus on interactive UI and scalable state management:

*   **Core Language**: TypeScript (Primary), JavaScript.
### Key Modules
| Module | Purpose | Owner |
|--------|---------|-------|
| `src` | The src module serves as the core codebase for a comprehensive threat modeling a | — |
| `.claude` | The .claude module serves as the core engine for the ui-ux-pro-max skill set | — |
| `root` | The root module serves as the configuration and orchestration layer for the proj | — |
### Entry Points
- `src/App.tsx`
- `src/main.tsx`
### Tech Stack
...
|------|-------|-------------|-------|
| `src/services/analysis/threatEngine.ts` | 98.8th %ile | 3 | Yashwant |
| `src/components/input/InterviewWizard.tsx` | 97.6th %ile | 3 | Yashwant |
| `src/components/analysis/ThreatCard.tsx` | 96.4th %ile | 4 | Yashwant |
| `src/pages/AnalysisPage.tsx` | 95.2th %ile | 5 | Yashwant |
| `src/components/analysis/HealthScoreGauge.tsx` | 94.0th %ile | 4 | Yashwant |
